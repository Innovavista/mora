  ...
  $.DurationPicker = function DurationPicker(mainElement, options) {
    ...
    plugin.init = function init() {
      ...
      var mainInputReplacer = $('<div>', {
        class: 'bdp-input',
        html: [buildDisplayBlock('days', !plugin.settings.showDays), buildDisplayBlock('hours', !plugin.settings.showHours, plugin.settings.showDays ? 23 : 99999), buildDisplayBlock('minutes', !plugin.settings.showMinutes, 59), buildDisplayBlock('seconds', !plugin.settings.showSeconds, 59)]
      });
